...
const Contactusform = () => {
    ...
    const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        console.log('Submitting data:', inputValues);
        ...
        fetch('https://nexuspc.ru/api/contactus/', {
            method: 'POST',
            headers: {
                            ...
                            >
                                <Dialog.Panel
                                    ...
                                    <div className="py-8 lg:py-8 px-4 mx-auto max-w-screen-md">
                                        ...
                                        <p className="mb-8 lg:mb-16 mt-8 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl"> {t('modalDescription')}</p>
                                        <form action="#" className="space-y-8" onSubmit={handleSubmit}>
                                            <div>
                                                <label htmlFor="text"
                                                       className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">{t('nameLabel')}</label>
                                                <input
                                                    id="text"
                                            ...
                                            <div>
                                                <label htmlFor="email"
                                                       className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">{t( "emailLabel")}</label>
                                                <input
                                                    id="email"
                                                    name="input2"
                                            ...
                                            <div className="sm:col-span-2">
                                                <label htmlFor="message"
                                                       className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">{t( "messageLabel")}</label>
                                                <textarea
                                                    id="message"
                                                    name="input3"
