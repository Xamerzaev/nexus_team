...
const products: ProductType[] = [
  {
    id: 1,
    section: "Меню",
    link: ['Главная', 'services-section', 'aboutus-section'],
  },
  {
    id: 3,
    section: "Вакансии",
...
const sectionNames = {
    ...
    'aboutus-section': 'О нас',
    'faq-section': 'FAQ',
    'https://forms.yandex.ru/cloud/6560c3f0d04688326ed940c9/': 'Разработчики',
  ...
  <div className="mx-auto max-w-2xl pt-24 pb-18 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <div className="mt-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
          ...
          <div className="col-span-4">
            <h3 className="text-white text-4xl font-semibold leading-9 mb-4 lg:mb-20"> Мы в соц.сетях</h3>
...
<div className="footer-icons" style={{ padding: '18px 20px' }}>
  <Link href="https://www.instagram.com/nexuspc.ru/">
    <Image src={'/images/footer/instagram.svg'} alt="instagram" width={20} height={20} />
                  ...
                  <li key={index} className="mb-5">
                    <Link href={`#${link}`} passHref>
                      <div className="text-white text-lg font-normal mb-6 space-links">
                        {sectionNames[link as keyof typeof sectionNames] || link}
                      </div>
                    </Link>
                  </li>
                ))}
          ...
          {/* COLUMN-4 */}
          <div className="col-span-4">
            <h3 className="text-white text-4xl font-semibold leading-9 mb-4 lg:mb-20">Наши контакты</h3>
            <div className="text-white">
              <p>Телефон: +7 905 040-40-47</p>
          ...
          <div className="mt-4 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 xl:gap-x-8">
            <div>
              <h3 className="text-center md:text-start text-offwhite text-lg">
                @2023 - Любое использование контента без письменного разрешения запрещено <Link href="/" target="_blank"> NexusPC</Link>
              </h3>
            </div>
            <div className="flex justify-center md:justify-end">
            {/* <Link href="/privacy">
                <h3 className="text-offwhite pl-6 border-solid border-l border-footer">Политика конфиденциальности</h3>
              </Link> */}
            </div>
          </div>
        </div>
