                            ...
                            >
                                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                    ...
                                    <div className="py-8 lg:py-8 px-4 mx-auto max-w-screen-md">
                                        ...
                                        <p className="mb-8 lg:mb-16 mt-8 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Хотите связаться с нами? Все легко, заполните форму ниже!</p>
                                        <form action="#" className="space-y-8" onSubmit={handleSubmit}>
                                            ...
                                            <div className="sm:col-span-2">
                                                ...
                                                <textarea
                                                    ...
                                                    onChange={handleChange}
                                                    className="relative block w-full appearance-none  rounded-md border border-linegrey px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="Введите сообщение..."></textarea>
                                            </div>
                                            <button
                                                type="submit"
                                                disabled={isDisabled}
