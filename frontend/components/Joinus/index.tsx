    ...
    const handleSubmit = () => {
        ...
        fetch('https://nexuspc.ru/api/subscribe/', {
            ...
            .then(data => {
                ...
                setMessage({ type: 'success', content: (t("subscription")) });
        ...
        <div className="bg-joinus my-32">
            <div className='mx-auto max-w-2xl lg:max-w-7xl sm:py-4 lg:px-8'>
                <div className="text-center">
                    ...
                    <h2 className="text-4xl sm:text-65xl font-bold my-6 leading-10">  {t.rich('title', {br:(chunks) => <br/>})}
                    </h2>
                    <p className="font-medium text-lightblack text-2xl mt-5 text-center ">{t.rich('text', {br:(chunks) => <br/>})}</p>
                </div>
